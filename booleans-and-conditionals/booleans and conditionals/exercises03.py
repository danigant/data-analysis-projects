...
if fuel_level < 1000 or engine_temperature > 3500 or engine_indicator_light == 'red blinking':
    ...
    print("Fuel level above 50%. Engine good.")
...
if fuel_level > 20000 and engine_indicator_light != 'red blinking' or commnad_overide == True:
    print("Cleared to Launch!")
else:
     print("Launched scrubbed!")
