...
def reverse_characters(value):
    if type(value) == int:
        str_num = str(value)
        reversed_string = reverse_characters(str_num)
...
print(reverse_characters(value))
...
print(reverse_everything(list_test1))
print(reverse_everything(list_test2))
print(reverse_everything(list_test3))
